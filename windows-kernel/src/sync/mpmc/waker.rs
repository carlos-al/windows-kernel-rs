...
use windows_kernel_sys::base::HANDLE;
...
impl Waker {
    ...
    #[inline]
    pub fn register_with_packet(&mut self, oper: Operation, packet: *mut (), cx: &Context) {
        ...
        if self.selectors.is_empty() {
            ...
            self.selectors
                ...
                .position(|selector| {
                    ...
                    selector.cx.thread_id() != thread_id as usize
...
pub fn current_thread_id() -> HANDLE {
    let dummy: Thread = thread::current();
    dummy.into_handle()
}
